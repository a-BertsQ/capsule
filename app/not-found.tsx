      ...
      <div className="not-found-content">
        ...
        <div className="not-found-message">
          ...
          <p className="not-found-description">
            ...
            Mungkin ada kesalahan pengetikan di URL atau halaman telah dihapus.
          </p>
        </div>

        {/* Action buttons */}
        <div className="not-found-actions">
          <Link href="/" className="btn-primary-404">
            <svg
        ...
        <div className="not-found-quick-links">
          <p className="quick-links-title">Atau coba link ini:</p>
          <div className="quick-links-grid">
            <Link href="/dashboard" className="quick-link-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <Link href="/learn" className="quick-link-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="not-found-help">
          <p className="help-text">
            ...
            <a href="mailto:support@capsule.id" className="help-link">
              support@capsule.id
            </a>
          </p>
        </div>
